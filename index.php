...
<head>
	...
	<title>Shoppun - Everything you need</title>
	...
	<div class="body-content outer-top-xs" id="top-banner-and-menu">
		<div class="container">
			<div class="furniture-container homepage-container">
				...
				<!-- ============================================== SCROLL TABS ============================================== -->
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp" style="padding-top: 40px;">
												...
												<div class="product">
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															<span class="price">
																<?php echo number_format($row['productPrice'], 0, '.', '.'); ?> Vnd</span>
															<span class="price-before-discount"><?php echo number_format($row['productPriceBeforeDiscount'], 0, '.', '.'); ?> Vnd</span>
											...
											<div class="products">
												...
												<div class="product">
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															<span class="price">
																<?php echo htmlentities($row['productPrice']); ?>.000 Vnd</span>
															<span class="price-before-discount">0<?php echo htmlentities($row['productPriceBeforeDiscount']); ?>.00 Vnd</span>
											...
											<div class="row product-micro-row">
												...
												<div class="col col-xs-6">
													<div class="product-info">
														...
														<div class="product-price">
															<span class="price">
																<?php echo number_format($row['productPrice'], 0, '.', '.'); ?> Vnd
															</span>
														</div><!-- /.product-price -->
														<?php if ($row['productAvailability'] == 'In Stock') { ?>
															<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Add to Cart</a></div>
