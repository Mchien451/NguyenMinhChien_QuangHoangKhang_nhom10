								...
								<div class="product-info">
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="price-box">
													<span class="price"><?php echo number_format($row['productPrice'], 0, ',', '.'); ?> Vnd</span>
													<span class="price-strike"><?php echo number_format($row['productPriceBeforeDiscount'], 0, ',', '.'); ?> Vnd</span>
					...
					<div class="products">
						<div class="product">
							...
							<div class="product-info text-left">
								...
								<div class="product-price">
									<span class="price">
										<?php echo number_format($rw['productPrice'], 0, ',', '.'); ?> Vnd
									</span>
									<span class="price-before-discount">
										<?php echo number_format($rw['productPriceBeforeDiscount'], 0, ',', '.'); ?> Vnd
									</span>
								</div>
								<!-- /.product-price -->
