									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-sub-total item">Price Per unit (Vnd)</th>
												<th class="cart-sub-total item">Ship (Vnd)</th>
												<th class="cart-total last-item">Grandtotal (Vnd)</th>
											</tr>
										</thead><!-- /thead -->
										<tfoot>
											<tr>
											...
											if (!empty($query)) {
												while ($row = mysqli_fetch_array($query)) {
													...
													<tr>
														...
														<td class="cart-product-quantity col-xs-1">
														...
														<td class="cart-product-sub-total col-xs-2 "><span
																class="cart-sub-total-price">
																<?php echo number_format($row['productPrice'], 0, ',', '.'); ?>
															</span></td>
														<td class="cart-product-sub-total col-xs-1"><span
																class="cart-sub-total-price">
																<?php echo number_format($row['shippingCharge'], 0, ',', '.'); ?>
															</span></td>

														<td class="cart-product-grand-total">
															<span class="cart-grand-total-price">
																<?php echo number_format(($_SESSION['cart'][$row['id']]['quantity'] * $row['productPrice'] + $row['shippingCharge']), 0, ',', '.'); ?>
															</span>
														</td>
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<div class="form-group">
														<label class="info-title" for="Billing Address"
															style="color:black">Billing Address<span>*</span></label>
													...
													<div class="form-group">
														<label class="info-title" for="Billing Pincode"
															style="color:black">Billing Pincode <span>*</span></label>
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<div class="form-group" ;>
														<label class="info-title" " for=" Shipping Address"
															style="color:black">Shipping Address<span>*</span></label>
														<textarea class="form-control unicase-form-control text-input"
													...
													<div class="form-group">
														<label class="info-title" for="Billing Pincode"
															style="color:black">Shipping Pincode <span>*</span></label>
														<input type="text" class="form-control unicase-form-control text-input"
									...
									<tr>
										<th>
											<div class="cart-grand-total">
												Grand Total: <span class="inner-md">
